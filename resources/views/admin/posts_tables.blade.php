...
<main class="h-full overflow-y-auto">
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div>
            <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"> Total Posts </p>
            <p class="text-lg font-semibold text-gray-700 dark:text-gray-300"> 6389 </p>
        </div>
        </div>
        <!-- Card -->
        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
            <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"> Views Total </p>
            <p class="text-lg font-semibold text-gray-700 dark:text-gray-300"> 46,760.89 </p>
        </div>
        </div>
        <!-- Card -->
        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
            <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"> New Posts </p>
            <p class="text-lg font-semibold text-gray-700 dark:text-gray-300"> 376 </p>
        </div>
        </div>
        <!-- Card -->
        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
            ...
            <p class="text-lg font-semibold text-gray-700 dark:text-gray-300"> 35 </p>
        </div>
        </div>
    </div>
    <!-- Total list with actions -->
    <hr>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        ...
        <table class="w-full whitespace-no-wrap">
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm"> Photo 1 </td>
                ...
                <td class="px-4 py-3 text-sm"> 86345 </td>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        ...
        <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
            ...
            <ul class="inline-flex items-center">
                ...
                <li><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple"> 1 </button></li>
                <li><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple"> 2 </button></li>
                <li><button class="px-3 py-1 text-white transition-colors duration-150 bg-purple-600 border border-r-0 border-purple-600 rounded-md focus:outline-none focus:shadow-outline-purple">
                    3 </button>
                </li>
                <li><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple"> 4 </button></li>
