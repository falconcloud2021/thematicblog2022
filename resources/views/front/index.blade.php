...
<body class="overflow-x-hidden antialiased">
    ...
    <header class="relative z-50 w-full h-24">
        <div class="container flex items-center justify-center h-full max-w-6xl px-8 mx-auto sm:justify-between xl:px-0">
            ...
            <div
                ...
                <a href="#_" class="relative z-40 px-3 py-2 mr-0 text-sm font-bold text-pink-500 md:px-5 lg:text-white sm:mr-3 md:mt-0">Login</a>
                <a href="#_"
    ...
    <footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
        ...
        <div class="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">© 2020 Landmark. All rights reserved.</div>
